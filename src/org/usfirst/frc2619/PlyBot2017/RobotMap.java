...
public class RobotMap {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        // Encoders are on 11 and 2 (leftFront and rightFront)
        // Set the non-encoder'd talons to follow:
        driveTrainLeftRearMotor.changeControlMode(TalonControlMode.Follower);
        driveTrainLeftRearMotor.set(driveTrainLeftFrontMotor.getDeviceID());
        driveTrainRightRearMotor.changeControlMode(TalonControlMode.Follower);
