...
import org.usfirst.frc2619.PlyBot2017.subsystems.drivetrain.motionrecord.DriveTrainRecordConfigration;
import org.usfirst.frc2619.motionrecording.MotionPlaybackCommand;
import org.usfirst.frc2619.motionrecording.MotionRecordCommand;
...
public class OI {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        // Add our motion recorder:
        DriveTrainRecordConfigration dtConfig = new DriveTrainRecordConfigration();
        SmartDashboard.putData("RecordDriveTrain", new MotionRecordCommand(dtConfig));
        SmartDashboard.putData("PlayRecordDriveTrain", new MotionPlaybackCommand(dtConfig));
        
        recordButton = new JoystickButton(leftJoystick, 1);
        recordButton.whileHeld(new MotionRecordCommand(dtConfig));
    }
