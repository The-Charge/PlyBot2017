...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("GetToGearPegLeft", new GetToGearPegLeft());
        SmartDashboard.putData("GetToGearPegMiddle", new GetToGearPegMiddle());
        SmartDashboard.putData("GetToGearPegRight", new GetToGearPegRight());
