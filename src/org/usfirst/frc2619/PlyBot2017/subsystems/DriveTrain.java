...
public class DriveTrain extends Subsystem {
	...
	public double OUTER_TURN = .5;
	public double INNER_TURN = -.5;
	...
	private static final String OUTER_TURN_KEY = "OUTER_TURN";
	private static final String INNER_TURN_KEY = "INNER_TURN";
    ...
    public void writeDefaultValues() {
    	...
    	SmartDashboard.putNumber(DEADBAND_TWIST_KEY, DEADBAND_TWIST);
    	SmartDashboard.putNumber(OUTER_TURN_KEY, OUTER_TURN);
    	SmartDashboard.putNumber(INNER_TURN_KEY, INNER_TURN);
    }
    ...
    public void readDefaultValues() {
    	...
    	OUTER_TURN = SmartDashboard.getNumber(OUTER_TURN_KEY);
    	INNER_TURN = SmartDashboard.getNumber(INNER_TURN_KEY);
    }
    ...
    public void relTurn(double turnTo, double speed){
    	...
    	if(direction >= 0){	
    		leftSpeed = OUTER_TURN;
    		rightSpeed = INNER_TURN;
			//run(speed, -speed);
			SmartDashboard.putString("Direction", "right");
    	}
    	else if(direction < 0){
    		leftSpeed = INNER_TURN;
    		rightSpeed = OUTER_TURN;
    		//run(-speed, speed);
